      ...
      @foreach ($events as $event)
        <div class="py-8 flex flex-wrap md:flex-nowrap">
          ...
          <div class="md:flex-grow">
            ...
            <a class="text-indigo-500 inline-flex items-center mt-4" href="{{ route('event.page', [$event->slug]) }}"
              title="{{ $event->title }}">Mehr erfahren
              <svg class="w-4 h-4
                            ml-2" viewBox="0 0 24 24" stroke="currentColor"
